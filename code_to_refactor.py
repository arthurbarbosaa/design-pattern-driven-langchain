...
if __name__ == "__main__":
    ...
    service.send_notification("email", "Bem-vindo ao nosso sistema!", "usuario@exemplo.com")
    service.send_notification("sms", "Seu código de verificação é 12345.", "+5511999999999")
    service.send_notification("push", "Você tem uma nova mensagem.", "token_abc123")
